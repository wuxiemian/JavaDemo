...
//	}
	...
	public void keyPressed(KeyEvent e){
		switch (e.getKeyCode()) {
		case KeyEvent.VK_SPACE:yd.s=new Snake(yd);gameOver=false;yd.e=new Egg();break;
//		case KeyEvent.VK_F:this.setLive(true);break;
//		case KeyEvent.VK_W:tc.setWd();break;
//		case KeyEvent.VK_A:tc.createTank();break;
		case KeyEvent.VK_UP:if(head.dir==Dir.D) return;head.dir=Dir.U;break;
		case KeyEvent.VK_LEFT:if(head.dir==Dir.R) return;head.dir=Dir.L;break;
		case KeyEvent.VK_DOWN:if(head.dir==Dir.U) return;head.dir=Dir.D;break;
		case KeyEvent.VK_RIGHT:if(head.dir==Dir.L) return;head.dir=Dir.R;break;
		default:break;
		}
	}
