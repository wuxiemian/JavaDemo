...
public class Client extends Panel {
    ...
    private static Toolkit kt = Toolkit.getDefaultToolkit();
    ...
    static Image backgroundImage = kt.getImage(Client.class.getClassLoader().getResource("image/background.png"));
    Image offScreenImage = null;
    static Random rd = new Random();
    private Font font = new Font("宋体", Font.PLAIN, 20);
    int step = 0;
    private int score = 1195;
    private int damage = 0;
    private boolean gameOver = false;
    BOSS boss = new BOSS(200, 50, this);
    private int bossNum = 3;
